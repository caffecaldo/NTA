...
Gem::Specification.new do |s|
  ...
  s.files = [".document", "AUTHORS.rdoc", "CHANGELOG.rdoc", "LICENSE.rdoc", "README.rdoc", "Rakefile", "VERSION.yml", "bin/railroady", "lib/railroady.rb", "lib/railroady/aasm_diagram.rb", "lib/railroady/app_diagram.rb", "lib/railroady/controllers_diagram.rb", "lib/railroady/diagram_graph.rb", "lib/railroady/models_diagram.rb", "lib/railroady/options_struct.rb", "lib/railroady/railtie.rb", "lib/railroady/version.rb", "tasks/railroady.rake"]
